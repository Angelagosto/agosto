...
<form action="/action_page.php">
  ...
  <input type="radio" id="database" name="fruite" value="database" checked="checked">
       <label for="apple">DATABASE ADMIN</label>
    </div>
    <div class="form-group form-check">
    <input type="radio" id="software" name="fruite" value="software" checked="checked">
       <label for="apple">SOFTWARE DEVELOPER</label>
    </div>
    <div class="form-group form-check">
    <input type="radio" id="web" name="fruite" value="web" checked="checked">
       <label for="apple">WEB ADMINISTRATOR</label>
    </div>
    <div class="form-group form-check">
  <div class="form-group">
